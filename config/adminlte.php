...
return [
    ...
    */
    ...
    'dashboard_url' => env('ADMIN_PREFIX').'/dashboard',

    'logout_url' => env('ADMIN_PREFIX').'/logout',

    'login_url' => env('ADMIN_PREFIX').'/login',

    'register_url' => null,

    'password_reset_url' => env('ADMIN_PREFIX').'/password/reset',

    'password_email_url' => env('ADMIN_PREFIX').'/password/email',
