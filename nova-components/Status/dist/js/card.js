...
Nova.booting(function (Vue, router, store) {
  Vue.component('status', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            publicationDate: this.resource.fields.find(function (el) {
                return el.attribute == 'publication_date';
            }).value
        };
    },
    methods: {
...
var render = function() {
  ...
  return _c(
    "card",
    {
      staticClass: "card relative px-6 py-4 card-panel",
      class: _vm.isDraft()
        ? "bg-draft"
        : _vm.isOnline()
        ? "bg-published"
    ...
    [
      _c("div", { staticClass: "flex mb-4" }, [
        _c("h3", { staticClass: "mr-3 text-50 font-bold" }, [
          _vm._v(_vm._s(_vm.__("Status")))
        ])
      ]),
      _vm._v(" "),
      _c("p", { staticClass: "flex items-center text-3xl mb-3 text-white" }, [
        _vm._v(
          "\n        " +
            _vm._s(
              _vm.isDraft()
